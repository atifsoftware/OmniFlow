...
const defaultSettings: SettingsState = {
  ...
  jwt_secret: 'OmniFlowSecret2026!#$JwtSecureKey99x',
  jwt_expiry: '24h',
  rate_limit: '150',
  cors_origin: 'http://localhost:3000, https://omniflow.dev',
  helmet_enabled: true,
  csrf_enabled: true,
  cookie_samesite: 'Lax',

  cache_driver: 'Redis + In-Memory',
  cache_ttl: '3600',
